...
class _HomepageState extends State<Homepage> {
  ...
  void _fetchCategorySpending(int userId) async {
    ...
    print("Food Spending: $foodSpending");
    print("Transport Spending: $transportSpending");
    print("School Fees Spending: $schoolsSpending");
    print("Boarding Fees Spending: $boardingsSpending");
    print("Wants Spending: $wantsSpending");
    print("Others Spending: $othersSpending");
                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      boxShadow: [
                        BoxShadow(
                          color: const Color.fromARGB(255, 189, 186, 165).withOpacity(1.0),
                          spreadRadius: 2,
                          blurRadius: 5,
